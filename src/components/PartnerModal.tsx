      ...
      <div className="bg-[#191919] rounded-xl w-full max-w-md  shadow-2xl">
        <div className="p-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-bold bg-[#fdfff5]/70  bg-clip-text text-transparent">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-[#131313] border border-white/10 rounded-full focus:outline-none focus:ring-2 focus:ring-[#37e5a5]/50 text-gray-200 placeholder-gray-500"
                required
              />
            </div>
